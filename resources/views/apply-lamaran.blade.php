...
<body>
                        ...
                        <form class="needs-validation" action="/insert" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-outline-secondary" type="button" id="yearPickerButton">
                            ...
                            {{-- <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="year" name="year"
                                    placeholder="Pilih tahun" onchange="extractYear()">
                            </div> --}}

                            <div class="mb-3">
                                <label for="jabatan" class="form-label">Set Skill</label>
                                <select class="form-select" id="jabatan" name="jabatan">
                            ...
                            {{-- <div class="mb-3">
                                ...
                                <div class="multiselect">
                                    <select class="selectpicker" style="width: 600px" multiple id="set_skill"
                                        name="set_skill[]" data-live-search="true" size="7"
                                        placeholder="Pilih skill">
                                        <option class="disabled">Pilih skill</option>
                                        @foreach ($skills as $item)
                                            <option value="{{ $item->id }}">{{ $item->name }}</option>
                                        @endforeach
                                    </select>
    ...
    <script>
        $(document).ready(function() {
            var yearInput = $('#year');
            var yearPickerButton = $('#yearPickerButton');
            ...
            yearPickerButton.click(function() {
                yearInput.datepicker("show");
            });
        });
    </script>
    {{-- <script>
